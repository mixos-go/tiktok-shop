---
title: OrderStatusDataExchange
category: data_reconciliation
api_name: OrderStatusDataExchange
method: POST
...
**Category:** data_reconciliation
**API:** OrderStatusDataExchange

**Method:** POST
**HTTP Path:** https://open-api.tiktokglobalshop.com/data_reconciliation/202309/orders/sync
...
| --- | --- | --- | --- |
| shop_id (query) | integer | No | Tiktok shop seller shop id. |
