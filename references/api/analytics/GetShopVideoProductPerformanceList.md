---
title: GetShopVideoProductPerformanceList
category: analytics
api_name: GetShopVideoProductPerformanceList
method: GET
...
**Category:** analytics
**API:** GetShopVideoProductPerformanceList

**Method:** GET
**HTTP Path:** https://open-api.tiktokglobalshop.com/analytics/202509/shop_videos/{video_id}/products/performance
...
| sort_field (query) | string | No | Sort on. Available values: gmv, units_sold, daily_avg_buyers Default value: gmv |
...
| data.products.gmv.amount | string | No | GMV amount in the corresponding currency. (e.g. 0) |
| data.products.gmv.currency | string | No | GMV currency code (ISO 4217 standard). If LOCAL currency is requested, the value will be the local currency code of where the shop is registered (e.g. GBP). (e.g. USD) |
