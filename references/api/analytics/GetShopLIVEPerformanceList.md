---
title: GetShopLIVEPerformanceList
category: analytics
api_name: GetShopLIVEPerformanceList
method: GET
...
**Category:** analytics
**API:** GetShopLIVEPerformanceList

**Method:** GET
**HTTP Path:** https://open-api.tiktokglobalshop.com/analytics/202509/shop_lives/performance
...
| sort_field (query) | string | No | Field to sort on. Default: gmv Available values: - gmv - products_added - different_products_sold - sku_orders - items_sold - customers - 24h_live_gmv |
...
| data.live_stream_sessions.sales_performance.items_sold | integer | No | The total number of individual items sold from all LIVEs. Example: If a customer buys 3 units of SKU A and 2 units of SKU B, the items sold would be 5. (e.g. 122) |
