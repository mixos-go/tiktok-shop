---
title: GetShopVideoPerformanceOverview
category: analytics
api_name: GetShopVideoPerformanceOverview
method: GET
...
**Category:** analytics
**API:** GetShopVideoPerformanceOverview

**Method:** GET
**HTTP Path:** https://open-api.tiktokglobalshop.com/analytics/202509/shop_videos/overview_performance
...
| data.latest_available_date | string | No | Latest date in local timezone where data is ready (ISO 8601 format). (e.g. 2024-09-08) |
| data.performance | object | No | Overall performance data for videos. |
