---
title: GSSearchDeliveryOrders
category: gs_full_service_shipment
api_name: GSSearchDeliveryOrders
method: POST
...
**Category:** gs_full_service_shipment
**API:** GSSearchDeliveryOrders

**Method:** POST
**HTTP Path:** https://open-api.tiktokglobalshop.com/gs_full_service_shipment/202405/beta/delivery_orders/search
...
| is_sample_included | boolean | No | Whether sample product should be sent with bulk delivery. (e.g. False) |
...
| data.delivery_orders.skc.external_skc_code | string | No | The code of supplier-defined skc. (e.g. Skc-test0419) |
...
| data.delivery_orders.skc.platform_skc_code | string | No | The code of platform-defined skc. (e.g. S231210000072001) |
...
| data.delivery_orders.warehouse_contact.address_detail.country_name | string | No | The country name of the warehouse location (e.g. 中华人民共和国) |
