...
**Method:** POST
**HTTP Path:** https://open-api.tiktokglobalshop.com/gs_full_service_shipment/202405/preview/delivery_orders
...
| delivery_order.delivery_items | array<object> | No | The list of delivery item infomation |
